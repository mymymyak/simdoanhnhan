...
if (!empty($tag)) {
	...
	foreach($part as $key=>$value){
		if($value=="*"){
			...
			$str_hl = $str_hl."<span style='color:red'>$".$k."</span>";
...
<div class="divTable">
    ...
    <div class="divTableRow">
        ...
        <div class="divTableCell hidden-xs">
            <div class="mang">
				<amp-img src="<?= '/frontend/images2/'.$telco[$sim->telco]['tenmang'].'.png' ?>"
						 alt="Mua sim {{$telco[$sim->telco]['tenmang']}} giá rẻ" width="66"
						 height="<?= ($sim->telco == 1) ? "10" : "20"?>">
				</amp-img>
            </div>
        </div>
...
<?php if (!empty($linkgoiy)) : ?>
	<div class="boxgoiy suggest-duoisim" style="padding-top:12px;margin-bottom:10px"><span style="font-weight: bold;color: red;margin-right:5px">XEM THÊM:</span><?php foreach ($linkgoiy as $goiy) {echo $goiy;} ?></div>
<?php endif; ?>
</div>
@include($templateName.'.sim.filter')
