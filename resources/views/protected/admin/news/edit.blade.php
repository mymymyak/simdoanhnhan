    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="form-group {!! $errors->has('description') ? 'has-error' : '' !!}">
                ...
                <div class="controls">
                    {!! Form::textarea('description', $news->description, array('class'=>'form-control', 'id' => 'description', 'placeholder'=>'Description', 'value'=>Input::old('description'))) !!}
            ...
            <div class="form-group {!! $errors->has('detail') ? 'has-error' : '' !!}">
                ...
                <div class="controls">
                    {!! Form::textarea('detail', $news->detail, array('class'=>'form-control tinymce', 'id' => 'detail', 'placeholder'=>'Content', 'value'=>Input::old('detail'))) !!}
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="input-group">
                        ...
                        @endif
                        {!! Form::text('pic', $news->pic, array('class'=>'form-control', 'id' => 'fieldID1', 'placeholder'=>'Image', 'value'=>Input::old('pic'))) !!}
