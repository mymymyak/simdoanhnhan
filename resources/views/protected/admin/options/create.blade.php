...
<div class="col-lg-3">
    ...
    top: -25px;"><i class="fa fa-spinner fa-spin"></i></div>
                    {!! Form::select('option_name', $loaisim, null, ['class'=>'form-control']) !!}
                </div>
            </div>
            @else
            <div class="form-group">
    ...
    font-size: 16px;
    top: -25px;"><i class="fa fa-spinner fa-spin"></i></div>
                    {!! Form::text('option_name', null, array('class'=>'form-control', 'id' => 'option_name', 'placeholder'=>'Keyword', 'value'=>Input::old('option_name'))) !!}
                </div>
            </div>
            @endif
        </div>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    {!! Form::text('h1', null, array('class'=>'form-control', 'id' => 'h1', 'placeholder'=>'H1', 'value'=>Input::old('h1'))) !!}
                    @if ($errors->first('h1'))
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    {!! Form::textarea('description', null, array('rows' => 5,'class'=>'form-control', 'id' => 'description', 'placeholder'=>'Mô tả ngắn', 'value'=>Input::old('description'))) !!}
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    {!! Form::textarea('head', null, array('class'=>'form-control tinymce', 'id' => 'onpagehead', 'placeholder'=>'Mô tả ngắn', 'value'=>Input::old('head'))) !!}
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    {!! Form::textarea('foot', null, array('class'=>'form-control tinymce', 'id' => 'onpagefoot', 'placeholder'=>'Mô tả ngắn', 'value'=>Input::old('foot'))) !!}
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    {!! Form::textarea('sim_goi_y', null, array('class'=>'form-control', 'id' => 'sim_goi_y', 'placeholder'=>'Sim gợi ý', 'value'=>Input::old('sim_goi_y'))) !!}
