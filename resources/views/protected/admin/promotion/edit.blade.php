...
@section('content')
    {!! Form::open(['route' => ['promotion.update', $promotion->id], 'method' => 'PUT']) !!}
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group {!! $errors->has('store_id') ? 'has-error' : '' !!}">
                <label class="control-label" for="store_id">Mã kho</label>
                <div class="controls">
                    {!! Form::text('store_id', $promotion->store_id, array('class'=>'form-control', 'id' => 'store_id', 'placeholder'=>'Mã kho khuyến mãi', 'value'=>Input::old('store_id'))) !!}
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group {!! $errors->has('content') ? 'has-error' : '' !!}">
                ...
                <div class="controls">
                    {!! Form::textarea('content', $promotion->content, array('class'=>'form-control', 'id' => 'content', 'placeholder'=>'Nội dung khuyến mãi','value'=>Input::old('content'))) !!}
                    @if ($errors->first('store_id'))
                        <span class="help-block">{!! $errors->first('store_id') !!}</span>
                    @endif
                </div>
    ...
    <div class="row">
        <div class="col-sm-2">
            <div class="form-group {!! $errors->has('status') ? 'has-error' : '' !!}">
                ...
                <div class="controls">
                    {!! Form::select('status', \App\Models\TablePromotion::STATUS_LIST, $promotion->status,
                    array('class' => 'form-control select-status','value'=>Input::old('status')))  !!}
            ...
            <div class="form-group {!! $errors->has('active_at') ? 'has-error' : '' !!}">
                ...
                <div class="controls">
                    <div class="input-group date">
                        {!! Form::text('active_at', $promotion->active_at, array('class'=>'form-control datepicker', 'id' => 'active_at' , 'value'=>Input::old('active_at'))) !!}
    ...
    <div class="row expire-date-row">
        <div class="col-sm-2">
            <div class="form-group {!! $errors->has('expired_at') ? 'has-error' : '' !!}">
                ...
                <div class="controls">
                    <div class="input-group date">
                        {!! Form::text('expired_at', $promotion->expired_at, array('class'=>'form-control datepicker', 'id' => 'expired_at' , 'value'=>Input::old('expired_at'))) !!}
                        <div class="input-group-addon">
                            <span class="fa fa-calendar"></span>
                        </div>
                    </div>
